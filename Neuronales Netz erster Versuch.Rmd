...
dummy_list <- c("WindFct", "Warengruppe","BewoelkungsFct","Weekday","Zeit")
total_dummy = dummy_cols(total, dummy_list)

# Standardisierung von metrischen Variablen
norm_list <- c("Temperatur", "Arbeitslose", "Einwohnerzahl_Kiel", "Durchschnittstemperatur_monatlich", "Tagestemperatur_tatsaechlich","Ankuenfte","Uebernachtungen")
# Berechnung der Mittelwerte und Standardabweichungen der zu standardisierenden Variablen
norm_values_list <- get.norm_values(total_dummy, norm_list)
# Standardisierung der angegebenen metrischen Variablen
total_norm <- norm_cols(total_dummy, norm_values_list)
